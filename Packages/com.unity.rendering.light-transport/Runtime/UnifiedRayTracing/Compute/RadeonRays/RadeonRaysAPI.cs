...
{
    public enum IndexFormat { Int32 = 0, Int16 };

    public struct MeshBuildInfo
    {
    ...
    public struct MeshBuildMemoryRequirements
    {
    ...
    public struct SceneBuildMemoryRequirements
    {
        public ulong buildScratchSizeInDwords;
    }

    public class SceneMemoryRequirements
    {
        public ulong buildScratchSizeInDwords;
    ...
    public sealed class RadeonRaysShaders
    {
    ...
    public class RadeonRaysAPI : IDisposable
    {
