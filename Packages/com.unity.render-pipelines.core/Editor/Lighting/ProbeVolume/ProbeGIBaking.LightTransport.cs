            ...
            public RayTracingContext context
            {
                get
                {
                    //if (m_Context == null)
                    {
                        ...
                        m_Backend = RayTracingBackend.Compute; // RayTracingContext.IsBackendSupported(RayTracingBackend.Hardware) ? RayTracingBackend.Hardware : RayTracingBackend.Compute;
