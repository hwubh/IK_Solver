...
namespace UnityEngine.PathTracing.Integration
{
    ...
    internal static class LightmapIntegratorShaderIDs
    {
        ...
        public static readonly int ExcludeMeshAndEnvironment = Shader.PropertyToID("g_ExcludeMeshAndEnvironment");
        ...
        public static readonly int AASampleOffset = Shader.PropertyToID("g_AASampleOffset");
    ...
    internal class LightmapDirectIntegrator : System.IDisposable
    {
        ...
        private bool _excludeMeshAndEnvironment;
        ...
        public LightmapDirectIntegrator(bool excludeMeshAndEnvironment)
        {
            _excludeMeshAndEnvironment = excludeMeshAndEnvironment;
        }
        ...
        public void Prepare(IRayTracingShader accumulationShader, ComputeShader normalizationShader, ComputeShader expansionHelpers, SamplingResources samplingResources, RTHandle emptyExposureTexture)
        {
            ...
            _accumulationDispatchBuffer = RayTracingHelper.CreateDispatchDimensionBuffer();
        }
            ...
            bool newChunkStarted)
        {
            ...
            Util.BindPathTracingInputs(cmd, _accumulationShader, false, lightEvaluations, preExpose, 0, environmentIntensityMultiplier, RenderedGameObjectsFilter.OnlyStatic, _samplingResources, _emptyTexture);
            ...
            _accumulationShader.SetIntParam(cmd, LightmapIntegratorShaderIDs.ExcludeMeshAndEnvironment, _excludeMeshAndEnvironment ? 1 : 0);
    ...
    internal class LightmapIndirectIntegrator : System.IDisposable
    {
            ...
            bool newChunkStarted)
        {
            ...
            bool preExpose = false;
            float environmentIntensityMultiplier = 1.0f;
            Util.BindPathTracingInputs(cmd, _accumulationShader, _countNEERayAsPathSegment, lightEvaluations, preExpose, (int)bounceCount, environmentIntensityMultiplier, RenderedGameObjectsFilter.OnlyStatic, _samplingResources, _emptyTexture);
            Util.BindWorld(cmd, _accumulationShader, world, 1024);
    ...
    internal class LightmapAOIntegrator : System.IDisposable
    {
            ...
            bool newChunkStarted)
        {
            ...
            Util.BindPathTracingInputs(cmd, _accumulationShader, false, lightEvaluations, preExpose, 0, environmentIntensityMultipler, RenderedGameObjectsFilter.OnlyStatic, _samplingResources, _emptyTexture);
            Util.BindWorld(cmd, _accumulationShader, world, 1024);
    ...
    internal class LightmapShadowMaskIntegrator : System.IDisposable
    {
        ...
        SamplingResources _samplingResources;
        RTHandle _emptyTexture;
        bool _excludeMeshAndEnvironment;
        private GraphicsBuffer _accumulationDispatchBuffer;
        private ComputeShader _expansionHelpers;
        private int _populateAccumulationDispatchKernel;
        ...
        public LightmapShadowMaskIntegrator(bool excludeMeshAndEnvironment)
        {
            _excludeMeshAndEnvironment = excludeMeshAndEnvironment;
        }
