...
#define RAND_DIM_LIGHT_SELECTION  6    // used for light selection (arbitrarily many dimensions after this point)
...
#define QRNG_METHOD_SOBOL_BLUE_NOISE

#define QRNG_SOBOL_GENERATIVE_DIMS 256
