...
namespace UnityEngine.PathTracing.Integration
{
    ...
    internal class UVFallbackBuffer : IDisposable
    {
        ...
        public static int GetHashCode(int width, int height, UVMesh uvMesh, UVAccelerationStructure uvAS)
        {
            return System.HashCode.Combine(width, height, uvMesh.HashCode, uvAS.HashCode);
        }
