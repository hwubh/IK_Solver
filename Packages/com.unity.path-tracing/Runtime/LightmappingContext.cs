...
namespace UnityEngine.PathTracing.Lightmapping
{
    internal class LightmappingContext: IDisposable
    {
        ...
        public Handle<World.InstanceKey>[] lightmapCurrentLodInstances;
        ...
        internal bool Initialize(UnityComputeDeviceContext deviceContext, int width, int height, UnityComputeWorld world, LightmapResourceLibrary resources)
        {
            ...
            InitializeChartRasterizationBuffers();
        ...
        internal bool SetOutputResolution(int width, int height) // In case of failure, the context is disposed and is thus not usable anymore
        {
            ...
            IndirectDispatchRayTracingBuffer = RayTracingHelper.CreateDispatchDimensionBuffer();
        ...
        private void InitializeChartRasterizationBuffers()
        {
            ...
            {
                maxIndexCount = Mathf.Max(maxIndexCount, (int)World.Meshes[meshIdx].GetTotalIndexCount());
            }

            ChartRasterizerBuffers.vertex = new GraphicsBuffer(GraphicsBuffer.Target.Structured, maxIndexCount, UnsafeUtility.SizeOf<Vector2>());
            ChartRasterizerBuffers.vertexToOriginalVertex = new GraphicsBuffer(GraphicsBuffer.Target.Structured, maxIndexCount, sizeof(uint));
            ChartRasterizerBuffers.vertexToChartID = new GraphicsBuffer(GraphicsBuffer.Target.Structured, maxIndexCount, sizeof(uint));
        }
