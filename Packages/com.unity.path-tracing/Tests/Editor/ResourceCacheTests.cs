...
namespace UnityEngine.PathTracing.Tests
{
    ...
    internal class ResourceCacheTests
    {
        ...
        public void ResourceCache_AddInstance_ResourcesAreAdded()
        {
            ...
            instance.Build(mesh, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
        ...
        {
            Mesh mesh = TestUtils.CreateSingleTriangleMesh();
            Instance instance1 = new();
            instance1.Build(mesh, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance instance2 = new();
            instance2.Build(mesh, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance[] instances = { instance1, instance2 };
            Assert.IsTrue(m_ResourceCache.AddResources(instances, _context, m_Cmd, m_UVFBBuilder), "Expected that the instance could be added to cache.");
            Assert.AreEqual(1, m_ResourceCache.UVMeshCount(), "Expected that the cache has one uv mesh.");
            Assert.AreEqual(1, m_ResourceCache.UVAccelerationStructureCount(), "Expected that the cache has one uv acceleration structure.");
            Assert.AreEqual(1, m_ResourceCache.UVFallbackBufferCount(), "Expected that the cache has one uv fallback buffer.");
        ...
        public void ResourceCache_AddTwoInstancesDifferentMesh_TwoSetsOfResourcesAreAdded()
        {
            ...
            Instance instance1 = new();
            instance1.Build(mesh1, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance instance2 = new();
            instance2.Build(mesh2, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance[] instances = { instance1, instance2 };
            Assert.IsTrue(m_ResourceCache.AddResources(instances, _context, m_Cmd, m_UVFBBuilder), "Expected that the instance could be added to cache.");
        ...
        public void ResourceCache_AddTwoInstanceSameMeshDifferentResolution_TwoFallbackBuffersAreAdded()
        {
            ...
            Mesh mesh2 = mesh1;
            Instance instance1 = new();
            instance1.Build(mesh1, new Vector4(1, 1, 0, 0), new Vector2Int(5, 5), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance instance2 = new();
            instance2.Build(mesh2, new Vector4(1, 1, 0, 0), new Vector2Int(10, 10), Vector2Int.zero, Matrix4x4.identity, true, LodsIdentifier.Invalid);
            Instance[] instances = { instance1, instance2 };
            Assert.IsTrue(m_ResourceCache.AddResources(instances, _context, m_Cmd, m_UVFBBuilder), "Expected that the instance could be added to cache.");
